...
public class interfaz2 extends JFrame implements ActionListener{ 
    ...
    public interfaz2(String sugeto, String cosa1,String cosa2,String T,String B1,String B2){
        this.setTitle(T);
        ...
        descripcion.add(new JLabel("ID              Cliente                       RFC                        Correo electronico      "));
        ...
        try{
            ...
            String sql = "SELECT Clientes.Cliente AS prod, Clientes.RFC AS prec, Clientes.CorreoElectronico AS provee"+
            " FROM Clientes";
    ...
    public void actionPerformed(ActionEvent e) {//Acciones de los botones
        ...
        if(e.getSource() == jb3)
        {
            ...
            aljpc.get(0).add(new JLabel("Ingrese el id del cliente: "));
        ...
        if(e.getSource() == bcambiar)
        {
            ...
            try{
                ...
                {
                    case 0:
                        sql = "UPDATE Clientes SET Cliente = ?"+
                        "WHERE Id="+idc;       
                        break;
                    case 1:
                        sql = "UPDATE Clientes SET RFC = ?"+
                        "WHERE Id="+idc;       
                        break;
                    case 2:
                        sql = "UPDATE Clientes SET CorreoElectronico = ?"+
                        "WHERE Id="+idc;       
                        break;
                    default:
                        sql = "UPDATE Clientes SET CorreoElectronico = ?"+
        ...
        if (e.getSource() == bc)
        {
            ...
            try{
                ...
                Conexion1 conect = new Conexion1();
                con1 = conect.getConnection();
                String sql = "INSERT INTO Clientes (Cliente,RFC,CorreoElectronico)"+
                "VALUES (?,?,?)";
                PreparedStatement pst = con1.prepareStatement(sql);
                pst.setString(1, nom);
